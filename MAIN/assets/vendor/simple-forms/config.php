...
define('COMPANY_NAME',    "Arunoday Tech");          // not required, but recommended
define('YOUR_EMAIL',      "admin@arunodaytech.in");  // * Required, your email address, for example my-email@gmail.com
define('EMAILS_SUBJECT',  "New Form Submission");   // * Required, email subject
define('SEND_COPY_TO',    "abhi83166@gmail.com");                      // not required, comma separated emails: myemail@gmail.com, myemail2@gmail.com
...
define("RECAPTCHA_V3_SECRET_KEY", '6LfuyO8iAAAAAPoYHYE3jR01jrw5MqUtDDmR2OED'); // recaptcha version 3 SECRET_KEY
